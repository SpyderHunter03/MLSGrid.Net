...
namespace MLSGrid
{
    public class GridRequest
    {
            ...
            RequestOptions requestOptions)
        {
            ...
            this.GridHeaders = BuildGridHeaders(requestOptions);
        }
        ...
        /// </summary>
        public IDictionary<string, string> GridHeaders { get; }
        ...
        private static Dictionary<string, string> BuildGridHeaders(
            RequestOptions requestOptions)
        {
            var stripeHeaders = new Dictionary<string, string>
            {
                { "Stripe-Version", requestOptions?.StripeVersion ?? GridConfiguration.ApiVersion },
            };
