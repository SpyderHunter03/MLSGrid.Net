...
namespace MLSGrid
{
    ...
    public static class GridConfiguration
    {
        ...
        private static IGridClient stripeClient;

        static GridConfiguration()
        {
            StripeNetVersion = new AssemblyName(typeof(GridConfiguration).GetTypeInfo().Assembly.FullName).Version.ToString(3);
        }
        ...
        /// </code>
        /// </example>
        public static IGridClient StripeClient
        {
            get
            {
        ...
        private static GridClient BuildDefaultStripeClient()
        {
            ...
            return new GridClient(ApiKey, ClientId, httpClient: httpClient);
        }
    }
}
